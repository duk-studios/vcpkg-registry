...
set_target_properties(steamworks-sdk::steamworks-sdk PROPERTIES
        ...
        IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/steam_api.dll"
        IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/steam_api.lib"
)

list(APPEND _cmake_import_check_targets steamworks-sdk::steamworks-sdk )
list(APPEND _cmake_import_check_files_for_steamworks-sdk::steamworks-sdk "${_IMPORT_PREFIX}/lib/steam_api.lib" "${_IMPORT_PREFIX}/bin/steam_api.dll")
